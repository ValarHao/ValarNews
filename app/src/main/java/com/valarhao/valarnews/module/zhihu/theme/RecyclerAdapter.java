...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.zhihu_theme_recycler_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            itemCard = (CardView) view.findViewById(R.id.themeCard);
            itemImg = (ImageView) view.findViewById(R.id.imgThemeCard);
            itemTxtTitle = (TextView) view.findViewById(R.id.txtThemeCardTitle);
        }
    }

...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.zhihu_section_recycler_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            itemCard = (CardView) view.findViewById(R.id.sectionCard);
            itemImg = (ImageView) view.findViewById(R.id.imgSectionCard);
            itemTxtTitle = (TextView) view.findViewById(R.id.txtSectionCardTitle);
        }
    }
